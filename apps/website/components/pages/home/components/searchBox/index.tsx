...
export const Searchbox: FC = () => {
  ...
  return (
    <div className={cls("flex", "items-center", "justify-center", "py-20")}>
      <div
        className={cls(
          "max-w-2xl",
          "flex-grow",
      ...
      >
        <AutoComplete
          ...
          getLabel={getLabel}
          onClick={() => ""}
          searchLabel={TEXTS.WEBSITE_PAGE__HOME__DESCRIPTIOIN__SEARCH}
          placeholder={TEXTS.WEBSITE_PAGE__HOME__SEARCHBOX__PLACEHOLDER}
        />
      </div>
    </div>
  );
