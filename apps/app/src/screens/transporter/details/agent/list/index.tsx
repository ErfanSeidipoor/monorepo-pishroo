...
export const TransporterAgentsScreen: FC = () => {
  const {
    isValid,
    control,
    handleSubmitFilter,
  ...
  const renderItem = ({
    ...
    <CardDetails
      ...
      properties={[
        ...
        { label: TEXTS.TRANSPORTER, value: transporter.name },
        { label: TEXTS.CITY, value: transporter.city.province.name },
      ]}
      onClick={() =>
        navigate(TRANSPORTER_AGENT_DETAILS_ROUTE, { transporterAgentId: id })
      }
    />
  );
...
export default TransporterAgentsScreen;
