...
export type DeleteCallAdminMutationVariables = Exact<{
  deleteCallAdminInputs: DeleteCallAdminInputsGql;
}>;


export type DeleteCallAdminMutation = { __typename?: 'Mutation', deleteCallAdmin: { __typename?: 'Call', id: string, newPhone?: string | null, userId: string } };
...
export type GetTransporterActionsAdminQuery = { __typename?: 'Query', getTransporterActionsAdmin: { __typename?: 'PaginatedTransporterAction', pageInfo: { __typename?: 'PageInfo', totalEdges: number, edgeCount?: number | null, edgesPerPage: number, currentPage: number, totalPages: number }, edges: Array<{ __typename?: 'transporterAction', id: string, text: string, userId: string, transporter: { __typename?: 'Transporter', id: string, name: string, phone?: string | null, email?: string | null, description: string, address?: string | null }, user: { __typename?: 'User', id: string, firstName?: string | null, username: string, lastName?: string | null } }> } };
...
export type AddImageToUserAdminMutationVariables = Exact<{
  addImageToUserAdminInputs: AddImageToUserAdminInputsGql;
}>;


export type AddImageToUserAdminMutation = { __typename?: 'Mutation', addImageToUserAdmin: { __typename?: 'User', id: string } };
...
export type GetUserByIdAdminQuery = { __typename?: 'Query', getUserByIdAdmin?: { __typename?: 'User', id: string, createdAt: any, updatedAt?: any | null, username: string, firstName?: string | null, lastName?: string | null, email?: string | null, phone?: string | null, roles: Array<UserRoleEnum>, isActive?: boolean | null, fileUses: Array<{ __typename?: 'FileUse', id: string, file: { __typename?: 'File', filename: string, id: string } }>, provinceUsers: Array<{ __typename?: 'ProvinceUser', id: string, provinceId: string, province: { __typename?: 'Province', id: string, name: string } }> } | null };
...
export const DeleteCallAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"deleteCallAdmin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"deleteCallAdminInputs"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"DeleteCallAdminInputsGQL"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"deleteCallAdmin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"deleteCallAdminInputs"},"value":{"kind":"Variable","name":{"kind":"Name","value":"deleteCallAdminInputs"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"newPhone"}},{"kind":"Field","name":{"kind":"Name","value":"userId"}}]}}]}}]} as unknown as DocumentNode<DeleteCallAdminMutation, DeleteCallAdminMutationVariables>;
...
export const AddImageToUserAdminDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"addImageToUserAdmin"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"addImageToUserAdminInputs"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"AddImageToUserAdminInputsGQL"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"addImageToUserAdmin"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"addImageToUserAdminInputs"},"value":{"kind":"Variable","name":{"kind":"Name","value":"addImageToUserAdminInputs"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<AddImageToUserAdminMutation, AddImageToUserAdminMutationVariables>;
