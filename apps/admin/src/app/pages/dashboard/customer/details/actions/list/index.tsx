...
export const CustomerActionListPage: FC = () => {
  const {
    rows,
    loading,
    pageInfo,
      ...
      >
        ...
        >
          <Typography variant="h4">
            {TEXTS.PAGE_CUSTOMER_ACTION__CUSTOMER_ACTION}
          </Typography>
          {renderFilterSidebar()}
        </Stack>
        <Button
          variant="outlined"
          label={TEXTS.PAGE_CUSTOMER_ACTION__NEW_CUSTOMER_ACTION}
          color="secondary"
          onClick={onNew}
          startIcon={<AddIcon />}
        ></Button>
...
export default CustomerActionListPage;
