...
export const TransporterActionListPage: FC = () => {
  const {
    rows,
    loading,
    pageInfo,
      ...
      >
        ...
        >
          <Typography variant="h4">
            {TEXTS.PAGE_TRANSPORTER_ACTION__TRANSPORTER_ACTION}
          </Typography>
          {renderFilterSidebar()}
        </Stack>
        <Button
          variant="outlined"
          label={TEXTS.PAGE_TRANSPORTER_ACTION__NEW_TRANSPORTER_ACTION}
          color="secondary"
          onClick={onNew}
          startIcon={<AddIcon />}
        ></Button>
...
export default TransporterActionListPage;
