...
import { DASHBOARD_CATEGORY_NEW_CATEGORY_ROUTE } from "@admin/constants";
    ...
    return (
      ...
      >
        <Stack
          ...
          spacing={2}
        >
          <Typography variant="h4">{TEXTS.PAGE_CATEGORY__CATEGORY}</Typography>
          {renderFilterSidebar()}
        </Stack>
        <Button
          variant="outlined"
          label={TEXTS.PAGE_CATEGORY__NEW_CATEGORY}
          color="secondary"
          onClick={() => navigate(DASHBOARD_CATEGORY_NEW_CATEGORY_ROUTE)}
          startIcon={<AddIcon />}
        ></Button>
      </Stack>
    );
      ...
      >
        ...
        <DialogActions>
          <Button
            ...
            color="inherit"
          />
          <Button onClick={onUpdateCategoryActivation} label={TEXTS.CONFIRM} />
        </DialogActions>
      </Dialog>
    );
  };
