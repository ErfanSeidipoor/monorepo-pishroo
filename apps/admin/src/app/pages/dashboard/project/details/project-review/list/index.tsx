...
export const ProjectReviewListPage: FC = () => {
  const {
    rows,
    loading,
    pageInfo,
      ...
      >
        ...
        >
          <Typography variant="h4">
            {TEXTS.PAGE_PROJECT_REVIEW__PROJECT_REVIEW}
          </Typography>
          {renderFilterSidebar()}
        </Stack>
        <Button
          variant="outlined"
          label={TEXTS.PAGE_PROJECT_REVIEW__NEW_PROJECT_REVIEW}
          color="secondary"
          onClick={onNew}
          startIcon={<AddIcon />}
        ></Button>
      ...
      >
        ...
        <DialogActions>
          <Button
            ...
            color="inherit"
          />
          <Button onClick={onDeleteProjectReview} label={TEXTS.CONFIRM} />
        </DialogActions>
      </Dialog>
    );
  };
