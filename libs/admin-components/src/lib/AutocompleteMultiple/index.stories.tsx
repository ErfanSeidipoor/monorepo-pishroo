...
} as ComponentMeta<typeof AutocompleteMultiple>;
...
const Template: ComponentStory<typeof AutocompleteMultiple<Item>> = (args) => {
  const [values, setValues] = useState<Item[]>([]);
  return (
    <AutocompleteMultiple
      {...args}
      selectedItems={values}
      onSelectItems={(values) => setValues(values)}
    />
  );
};
...
Controlled.args = {
  ...
  getLabel,
  getValue,
  selectedItems: [{ title: "12 Angry Men", year: 1957 }],
};
