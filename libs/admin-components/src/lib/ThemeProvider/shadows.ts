...
const createShadow = (color: any): Shadows => {
  ...
  return [
    ...
    `1px 2px 2px 2px rgba(44, 62, 80, 0.08)`, //19
    `1px 1px 4px rgba(44, 62, 80, 0.12)`, //20
    "inset -1px 0px 0px #F0F0F0, inset 0px 1px 0px #F0F0F0, inset 1px 0px 0px #F0F0F0", //21
    "0px 5px 12px rgba(44, 62, 80, 0.08)", //22
    "0 0 0 0.2rem rgba(25, 118, 210, 0.25)", //23
    "0px 3px 12px rgba(44, 62, 80, 0.08)", //24
  ];
};

const createCustomShadow = (color: any) => {
  const transparent = alpha(color, 0.24);
  const transparent08 = alpha(color, 0.08);
  ...
  return {
    ...
    card: `0px 3px 12px ${alpha(palette.light.primary.dark, 0.08)}`,
    input: `0 0 0 0.2rem ${alpha(palette.light.primary.main, 0.25)}`,
  };
};
